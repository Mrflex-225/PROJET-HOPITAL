...
public class EditAppointmentFormController implements Initializable{
    ...
    public void displayFields(){
        editApp_appointmentID.setText(Donnee.temp_appID);
        editApp_fullName.setText(Donnee.temp_appName);
        editApp_gender.getSelectionModel().select(Donnee.temp_appGender);
        editApp_mobileNumber.setText(Donnee.temp_appMobileNumber);
        editApp_address.setText(Donnee.temp_appAddress);
        editApp_description.setText(Donnee.temp_appDescription);
        editApp_diagnosis.setText(Donnee.temp_appDiagnosis);
        editApp_treatment.setText(Donnee.temp_appTreatment);
        editApp_doctor.getSelectionModel().select(Donnee.temp_appdocteur);
        editApp_specialized.getSelectionModel().select(Donnee.temp_appSpecialized);
        editApp_status.getSelectionModel().select(Donnee.temp_appStatus);
    }
    ...
    public void specializedList(){
        String sql = "SELECT * FROM docteur WHERE date_supp IS NULL AND id_docteur = '"
        ...
        try{
            ...
            ObservableList listData = FXCollections.observableArrayList();
            if(result.next()){
                listData.add(result.getString("specialite"));
            }
