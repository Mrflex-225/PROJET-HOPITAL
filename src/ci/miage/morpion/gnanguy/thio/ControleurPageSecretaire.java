...
public class ControleurPageSecretaire implements Initializable {
    ...
    void ConnexionCompte() {
        ...
        if (login_DoctorID.getText().isEmpty()
            ...
            String sql = "SELECT * FROM secretaire WHERE id_secretaire = ? AND mdp = ? AND date_supp IS NULL";
            ...
            try {
                ...
                String checkStatus = "SELECT status FROM secretaire WHERE id_secretaire = '"
                ...
                if (resultSet.next()) {
                    ...
                    if (resultSet.next()) {
                        ...
                        Donnee.secre_id = resultSet.getString("id_secretaire");
                        alert.MessageSucces("Login Successfully!");
                        Parent root = FXMLLoader.load(getClass().getResource("secretaireform.fxml"));
    ...
    void EnregistrementCompte(ActionEvent event) {
        if (register_nomcomplet.getText().isEmpty()
            ...
            String checkDoctorID = "SELECT * FROM secretaire WHERE id_secretaire = '"
            ...
            try {
                ...
                if (resultSet.next()) {
                    ...
                    String insertData = "INSERT INTO secretaire (nom_complet, email,id_secretaire, mdp, date, status) "
                            + "VALUES(?,?,?,?,?,?)";
