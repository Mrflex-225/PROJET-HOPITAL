...
public class ControleurPageTechnicien implements Initializable {
    ...
    void ConnexionCompte() {
        ...
        if (login_DoctorID.getText().isEmpty()
            ...
            alert.errorMessage("Incorrect Technicien ID/Password");
        } else {

            String sql = "SELECT * FROM technicien WHERE id_technicien = ? AND mdp = ? AND date_supp IS NULL";
            ...
            try {
                ...
                String checkStatus = "SELECT status FROM technicien WHERE id_technicien = '"
                ...
                if (resultSet.next()) {
                    ...
                    if (resultSet.next()) {
                        Donnee.secre_name = resultSet.getString("nom_complet");
                        Donnee.secre_id = resultSet.getString("id_technicien");
                        alert.MessageSucces("Login Successfully!");
                        Parent root = FXMLLoader.load(getClass().getResource("technicienform.fxml"));
                        Stage stage = new Stage();
                        stage.setTitle("Systeme gestion Hopital | Secretaire Main Form");
                        stage.setScene(new Scene(root));
                        stage.show();
                        login_loginBtn.getScene().getWindow().hide();
                    } else {
                        alert.errorMessage("Incorrect Secretaire ID/Password");
                    }
                }
    ...
    void EnregistrementCompte(ActionEvent event) {
        if (register_nomcomplet.getText().isEmpty()
            ...
            String checkDoctorID = "SELECT * FROM technicien WHERE id_technicien = '"
            ...
            try {
                ...
                if (resultSet.next()) {
                    ...
                    String insertData = "INSERT INTO technicien (nom_complet, email,id_technicien" +
                            ", mdp, date, status) "
                            + "VALUES(?,?,?,?,?,?)";
    ...
    public void changerPage(){
        ...
        }else if(login_user.getSelectionModel().getSelectedItem() == "Secretaire Portail"){
            try{
